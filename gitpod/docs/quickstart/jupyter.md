...
Learn how to set-up and understand the benefits of Gitpod **in less than 5 min** with our [Jupyter Notebook](https://github.com/gitpod-io/template-jupyter-notebook) template.
...
- Create a new repository based on the [Jupyter Notebook template](https://github.com/gitpod-io/template-jupyter-notebook/generate).
- Name it e.g. `my-jupyter-template`.
...
The revised URL is: `https://gitpod.io/#prebuild/https://github.com/<github_username>/<my-jupyter-template>`
