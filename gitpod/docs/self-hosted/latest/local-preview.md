...
> **Intended for:** This is intended to allow you to experience Gitpod Self-Hosted on your local machine purely for testing purposes.
>
> **Limitations:**
>
> - Performance is bound by the capabilities of your machine. Your experience is likely to be better when using the SaaS version ([gitpod.io](gitpod.io)) or when running on one of our [reference architectures](./reference-architecture/index)
